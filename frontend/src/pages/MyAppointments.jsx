                ...
                {appointments.map((item, index) => (
                    <div key={index} className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-4 border-b'>
                        ...
                        <div className='flex flex-col gap-2 justify-end text-sm text-center'>
                            ...
                            {!item.cancelled && item.payment && !item.isCompleted && <button onClick={()=>handleCopy(item._id)} className="sm:min-w-48 py-2 px-6 border rounded-lg text-sm font-medium text-white bg-black hover:bg-white hover:text-black  transition-all duration-300">Appointment ID : {item._id}</button>}
                        ...
                        <div className='flex flex-col gap-2 justify-end text-sm text-center'>
                            ...
                            {!item.cancelled && item.payment && !item.isCompleted && <button className='sm:min-w-48 py-2 border rounded text-black bg-green-300'>Paid</button>}
